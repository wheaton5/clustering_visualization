...
class PlayQuicksort(Scene):
    ...
    def construct(self):
        ...
        textpivot2 = Tex("For this, we need a temporary variable to avoid overwriting data when swapping values")
        ...
        textpivotgroup = VGroup(textpivot1, textpivot2, textpivot3, textpivot4, textpivot5, textpivot6, textpivot7, textpivot8, textpivot9).arrange(DOWN, buff=0.2).scale(0.6).shift(DOWN*2.25)
        ...
        self.play(FadeIn(nope), run_time=2)
        self.wait()
        ...
        self.play(MoveAlongPath(high, line), FadeOut(nope), run_time=2)
        self.wait() 
        ...
        self.play(MoveAlongPath(number_objects[1], line), run_time=2)
        line = Line(square_objects[13].get_center(), square_objects[1].get_center())
        self.play(MoveAlongPath(number_objects[13], line), run_time=2)
        line = Line(tmpsquare.get_center(), square_objects[13].get_center())
        self.play(MoveAlongPath(number_objects[1], line), FadeOut(nope), run_time=2)
        ...
        self.play(MoveAlongPath(low, line), FadeOut(nope), run_time=2)
        self.wait()
        ...
        self.play(MoveAlongPath(number_objects[2], line), run_time=2)
        self.wait()
        line = Line(square_objects[10].get_center(), square_objects[2].get_center())
        self.play(MoveAlongPath(number_objects[10], line), run_time=2)
        self.wait()
        ...
        self.play(FadeOut(nope))
        self.wait()
        self.play(Indicate(textpivot7), runtime=2)
        line = Line(number_objects[5].get_center(), tmpsquare.get_center())
        self.play(MoveAlongPath(number_objects[5], line), run_time=2)
        self.wait()
        line = Line(square_objects[8].get_center(), square_objects[5].get_center())
        self.play(MoveAlongPath(number_objects[8], line), run_time=2)
        self.wait()
        ...
        self.play(FadeIn(nope), run_time=2)
        self.wait()
        line = Line(low.get_center(), low.get_center()+LEFT*side_length)
        self.play(MoveAlongPath(low, line),FadeOut(nope), run_time=2)
